...
$id = $_GET['id'];
$stmt = $db->query("SELECT * FROM makanan WHERE id = $id");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $db-prepare("UPDATE makanan SET nama_makanan = ?, deskripsi_makanan = ?, kandungan_kalori = ?, kategori_makanan =? WHERE id = ?");
    $stmt-execute([$nama_makanan, $deskripsi_makanan, $kandungan_kalori, $kategori_makanan, $id]);
...
<body>
    <div class="container">
    <h2>Edit Rekomendasi Makanan Sehat</h2>
    <form action="tambah.php" method="Post">
        ...
        <label for="kandungan_kalori">Kandungan Kalori</label>
